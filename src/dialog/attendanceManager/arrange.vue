<template>
    <div class="arrange-bg">
        <Modal v-model="arrange_text" :styles="{top: '20px'}" width="700px">
            <div class="arrange">
                <div class="arrange-title">参与部门与人员</div>
            </div>
        ...
        watch:{
            'arrange':{
                handler:function (val) {
                    if (val){
                        this.arrange_text = val;
                        this.send_arrange(!val);
                    }
                }
            }
        },
