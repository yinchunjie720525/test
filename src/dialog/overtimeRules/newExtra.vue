<template>
    <div class="">
    <Modal title="Title" v-model="newExtra_text" class-name="vertical-center-modal" width="622px">
        ...
        <div class="extraShift">
            ...
            <div class="extraShift-title">
                ...
                <div class="exhibit1">
                    <div class="">
                        <RadioGroup v-model="vertical2" vertical @on-change="newExtra_change">
...
<script>
    ...
    export default {
        ...
        methods:{
            send_newExtra:function (data) {
                this.$emit('dialog_newExtra',data)
            },
            // 选择考勤组弹窗
            ...
            // 工作日需审批单选框
            newExtra_change: function (event) {
                console.log(event);
                this.current = event;
            },
            // 休息日和节假日允许加班开关按钮
        ...
        watch:{
            'newExtra':{
                handler:function (val) {
                    if (val){
                        this.newExtra_text = val;
                        this.send_newExtra(!val);
                    }
                }
            }
        },
